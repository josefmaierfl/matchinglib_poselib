...
#include <string>
#include <sys/stat.h>
//#include <unistd.h>//This was commented by JM:
#include <stdio.h>
#include <stdlib.h>
#include <sys/types.h>
#include <fcntl.h>
...
#include <sys/mman.h>
#else
//#include "annoy/mman.h" //This was commented by JM:
//#include <windows.h> //This was commented by JM:
#endif
...
//  //#define ANNOY_NODE_ATTRIBUTE __attribute__((__packed__)) //This was commented by JM:
//  // TODO: this is turned on by default, but may not work for all architectures! Need to investigate.
#ifdef __linux__ //This was added by JM:
#define ANNOY_NODE_ATTRIBUTE __attribute__((__packed__))
//#define ANNOY_NODE_ATTRIBUTE( __Declaration__ ) __Declaration__ __attribute__((__packed__))
//#else
//#define ANNOY_NODE_ATTRIBUTE( __Declaration__ ) __pragma( pack(push, 1) ) __Declaration__ __pragma( pack(pop) )
#endif
#endif
...
class AnnoyIndexInterface {
 public:
  ...
  //virtual bool save(const char* filename) = 0;//This was commentet by JM:
  virtual void unload() = 0;
  //virtual bool load(const char* filename) = 0;//This was commentet by JM:
...
protected:
...
#ifdef _DEBUG //This was added by JM
#ifdef __linux__ //This was added by JM
	  std::copy(indices.begin(), indices.end(), m->children);
#else
	  //This was added by JM
	  S* newAdress = (S*)m->children;
	  size_t indSize = sizeof(S);
	  //std::vector<S> ind1 = indices;
	  for (std::vector<S>::const_iterator it = indices.begin(); it < indices.end(); it++) {
		  memcpy(newAdress, (const S*)(&(*it)), indSize);
		  newAdress++;
	  }
#endif
#else
  ...
  void _get_all_nns(const T* v, size_t n, size_t search_k, vector<S>* result, vector<T>* distances) {
	...
	std::partial_sort(nns_dist.begin(), nns_dist.begin()+p, nns_dist.end(), [](pair<T, S> first, pair<T, S> second) {return first.first < second.first; });//This was added by JM

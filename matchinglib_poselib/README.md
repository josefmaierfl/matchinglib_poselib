...
* Stand-alone executables to
    ...
    * Calculate relative poses (mono and stereo cameras) based on images and calibration info (based on [KITTI format](https://s3.eu-central-1.amazonaws.com/avg-kitti/devkit_raw_data.zip)) stored on disk

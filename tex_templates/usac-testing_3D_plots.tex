...
\BLOCK{ if sec['diff_z_labels'] }
colorbar style={yticklabel=$10^{\pgfmathprintnumber{\tick}}$,scaled y ticks = false,ylabel=\VAR{sec['label_z'][loop.index0]}},
\BLOCK{ else }
colorbar style={yticklabel=$10^{\pgfmathprintnumber{\tick}}$,scaled y ticks = false,ylabel=\VAR{sec['label_z']}},
\BLOCK{ endif }
\BLOCK{ else }
\BLOCK{ if sec['diff_z_labels'] }

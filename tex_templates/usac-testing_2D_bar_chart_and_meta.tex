...
\BLOCK{ if sec['fig_type'] == 'xbar' }
ytick=data,
yticklabels from table={\datatable}{\VAR{ sec['label_x'] }},
y tick label style={rotate=45,anchor=east,align=right,text width=3.5cm,font=\scriptsize},
\BLOCK{ else }
xtick=data,
xticklabels from table={\datatable}{\VAR{ sec['label_x'] }},
x tick label style={rotate=45,anchor=east,align=right,text width=4cm,font=\scriptsize},
\BLOCK{ endif }
\BLOCK{ endif }
]
...
col sep=semicolon,\BLOCK{ if sec['print_meta'] }meta index=\VAR{ sec['plot_meta'][loop.index0] },\BLOCK{ endif }
\BLOCK{ if sec['use_string_labels'] }
\BLOCK{ if sec['fig_type'] == 'xbar' }
y expr=\coordindex
x=\VAR{ it }

...
y=\VAR{ (0.4 + 0.35 * sec['plots_l']|length)|round(2) }cm,%
bar width=0.3cm,%
enlarge y limits={true, abs value=\VAR{ (sec['plots_l']|length / 2)|round(2) }},%
/pgf/bar shift=-\VAR{ (0.1 + 0.35 * sec['plots_l']|length / 2)|round(2) }cm,%
\BLOCK{ else }
...
\BLOCK{ if sec['plots_l']|length > 1 }
x=\VAR{ (0.4 + 0.35 * sec['plots_l']|length)|round(2) }cm,%
bar width=0.3cm,%
enlarge x limits={true, abs value=\VAR{ (sec['plots_l']|length / 2)|round(2) }},%
/pgf/bar shift=-\VAR{ (0.1 + 0.35 * sec['plots_l']|length / 2)|round(2) }cm,%
\BLOCK{ else }
...
y=\VAR{ (0.4 + 0.35 * sec['plots_r']|length)|round(2) }cm,%
bar width=0.3cm,%
enlarge y limits={true, abs value=\VAR{ (sec['plots_r']|length / 2)|round(2) }},%
/pgf/bar shift=\VAR{ (0.1 + 0.35 * sec['plots_r']|length / 2)|round(2) }cm,%
\BLOCK{ else }
enlarge y limits={true, abs value=0.5},%
/pgf/bar shift=6pt,%
\BLOCK{ endif }
...
\BLOCK{ if sec['plots_r']|length > 1 }
x=\VAR{ (0.4 + 0.35 * sec['plots_r']|length)|round(2) }cm,%
bar width=0.3cm,%
enlarge x limits={true, abs value=\VAR{ (sec['plots_r']|length / 2)|round(2) }},%
/pgf/bar shift=\VAR{ (0.1 + 0.35 * sec['plots_r']|length / 2)|round(2) }cm,%
\BLOCK{ else }
enlarge x limits={true, abs value=0.5},%
/pgf/bar shift=6pt,%

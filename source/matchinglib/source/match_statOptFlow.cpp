 ...
 */
inline unsigned int getHammingL1(const Mat &vec1, const Mat &vec2)
{
 ...
 * Return value:				L1-norm of the hamming distance
 */
inline unsigned int getHammingL1PopCnt(Mat const& vec1, Mat const &vec2, unsigned char byte8width)
{
#if _USE_HW_POPCNT_
  #ifdef __linux__

...
typedef int (*PLS)(double *A, double *B, double *x, int m, int iscolmaj, int verbosity, double *pRetError);
...
int sba_motstr_levmar_x(
    ...
    double info[SBA_INFOSZ]
                        ...
                        * info[10]= # first encountered CLAPACK Error Code [0 for no error,  d: leading minor of order d is not positive definite
...
*/
   ...
   /* compute initial damping factor */
    ...
    while(1){
      ...
      issolved=sba_Axb_Chol(S, E+mcon*cnp, dpa+mcon*cnp, Sdim, MAT_STORAGE, verbose, &info[10]); linsolver=sba_Axb_Chol;
...
freemem_and_return: /* NOTE: this point is also reached via a goto! */
  ...
  if(linsolver) (*linsolver)(NULL, NULL, NULL, 0, 0, 0, NULL);
   ...
   /* compute initial damping factor */
    ...
    while(1){
      ...
      for(j=nsolved=mcon; j<m; ++j){
		    ...
		    nsolved+=sba_Axb_Chol(ptr1, ptr2, ptr3, cnp, 0, verbose, &info[10]); linsolver=sba_Axb_Chol;
   ...
   /* compute initial damping factor */
    ...
    while(1){
      ...
      for(i=nsolved=ncon; i<n; ++i){
        ...
        nsolved+=sba_Axb_Chol(ptr1, ptr2, ptr3, pnp, 0, verbose, &info[10]); linsolver=sba_Axb_Chol;

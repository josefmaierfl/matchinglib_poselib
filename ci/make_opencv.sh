...
FLAGS="-DBUILD_DOCS=OFF -DBUILD_PERF_TESTS=OFF -DBUILD_APPS=OFF -DBUILD_TESTS=OFF -DWITH_CUDA=OFF -DWITH_IPP=ON -DWITH_TBB=ON  -DEIGEN_INCLUDE_PATH=/usr/include/eigen3  -DENABLE_AVX=ON "
